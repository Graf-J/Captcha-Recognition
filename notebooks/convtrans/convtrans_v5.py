...
wandb.init(
    ...
    name="Convolutional-Transformer:v5",
    config={
...
# Save the file
with open("test_file_list_convtrans_v5.txt", "w") as f:
    for path in test_paths:
        f.write(path + "\n")

print(f"Saved {len(test_paths)} pointers to test_file_list_convtrans_v5.txt")
...
state_dict = torch.load(
    Captcha_Convolutional_Transformer_V1.SAVE_DIR / "v3.pth", 
    map_location=device,
    weights_only=True 
)
