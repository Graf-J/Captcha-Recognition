...
wandb.init(
    ...
    name="Convolutional-Transformer:v4",
    config={
        "learning_rate": 0.0005,
        "architecture": "ConvTrans_V1",
        "dataset": "clean_augmented_images_v2",
        "epochs": 100,
        "batch_size": 128,
        "optimizer": "Adam",
...
with open("test_file_list_convtrans_v4.txt", "w") as f:
    for path in test_paths:
        f.write(path + "\n")

print(f"Saved {len(test_paths)} pointers to test_file_list_convtrans_v4.txt")
...
for epoch in range(num_epochs):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), model.SAVE_DIR / "v4.pth")
